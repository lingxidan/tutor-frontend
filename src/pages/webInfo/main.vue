  ...
  methods: {
    ...
    handleScroll() {
      ...
      if (scrollTop > topHeight) {
        ...
        // _search.style.background = "linear-gradient(to bottom,#233A48 5%, transparent 50%)"
        _search.style.background = "rgba(99, 158, 121, .2)"
...
.postCard {
  .title {
    ...
    width: 100%;
    margin: 2.5vh 0 1vh;
    border-left: 0.5vw solid @thirthColor;
    padding: 0.8vh;
    padding-left: 1.3vw;
    background: linear-gradient(to right,@mainColor 5%, transparent 50%);
    color: #f7f7f7;
    display: flex;
    .name{
      width: 30%;
